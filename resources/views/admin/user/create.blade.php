                ...
                <div class="card-body">
                    <form action="/admin/user" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nome"class="form-control" name="nome" placeholder="Nome do usuário">
                        </div>
                        <div class="form-group">
                            <label for="email">Email: </label>
                            <input type="email" id="email" class="form-control" name="email" placeholder="E-mail do usuário">
                        </div>
                        <div class="form-group">
